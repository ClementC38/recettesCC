...
##
golem::fill_desc(
  pkg_name = "recettesCC", # The Name of the package containing the App
  pkg_title = "Recettes de cuisine de Clément", # The Title of the package containing the App
  pkg_description = "Mon livre de recettes (surtout des desserts).", # The Description of the package containing the App
...
# golem::use_favicon(path = "www/hex-recettesCC.png") # path = "path/to/ico". Can be an online file.
